        ...
        <div className="Main1">
            ...
            <div className="Main1_Num">
                <div className="Main1_num1">
                    <img className="Main1_num1_bg" src="/images/Num_bg_Reg.png" alt="Main_1"/>
            ...
            <div className="Main1_text">
                ...
                <input className="Main1_ans" type="text" id="Username" placeholder="Username" required />
                <button onClick={()=>navigate("/Register2")} className="Main1_button">Continue</button>
            </div>
        </div>
    );
}
