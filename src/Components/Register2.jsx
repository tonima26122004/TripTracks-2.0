        ...
        <div className="Main1">
            ...
            <div className="Main1_Num">
                ...
                <div className="Main2_num2">
                    <img className="Main1_num1_bg" src="/images/Num_bg_Reg.png" alt="Main_2"/>
            ...
            <div className="Main1_text">
                ...
                <input className="Main1_ans" type="text" id="email" placeholder="Username@gmail.com" required />
                <button onClick={()=>navigate("/Register3")} className="Main1_button">Continue</button>
            </div>
        </div>
    );
}
